...
export default function PatientMessagesPage() {
  ...
  return (
    <section className="patient-page">
      ...
      <article className="patient-chat-layout">
            ...
            <ul className="patient-chat-list">
              {conversations.map((conversation) => (
                <li key={conversation.id}>
                  ...
                  >
                    <strong>{otherParticipantName(conversation, myUserId)}</strong>
        ...
        <section className="patient-chat-thread">
          <header className="patient-chat-thread-head">
            <h3>
              {selectedConversation
                ? otherParticipantName(selectedConversation, myUserId)
